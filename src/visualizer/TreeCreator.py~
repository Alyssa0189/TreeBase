...
minTreeHeight = 0.4
maxTreeHeight = 2.4
contribCeiling = 30.0   # This number of contributions or higher will result in the tallest tree.

greenestTreeColor = (0.0, 0.588, 0.0)
deadestTreeColor = (0.98, 0.588, 0.0)
badQualityCeiling = 50.0    # Code of quality this bad or greater will result in the deadest tree.
...
showLeaves=False, useArm=False, seed=0, handleType='1', levels=2, length=("

commandStrAfterHeight = ", 0.3, 0.6, 0.45), lengthV=(0, 0, 0, 0), branches=(0, 50, 30, 10), curveRes=(3, 5, 3, 1), curve=(0, -40, -40, 0), \
curveV=(20, 50, 75, 0), curveBack=(0, 0, 0, 0), baseSplits=0, segSplits=(0, 0, 0, 0), splitAngle=(0, 0, 0, 0), splitAngleV=(0, 0, 0, 0), \
scale=13, scaleV=3, attractUp=0.5, shape='7', baseSize=0.4, ratio=0.015, taper=(1, 1, 1, 1), ratioPower=1.2, downAngle=(90, 60, 45, 45), \
...
def createTree(contribs, quality):
    ...
    # Calculate the tree's height based on the contributions
